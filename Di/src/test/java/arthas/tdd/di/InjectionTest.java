...
public class InjectionTest {
    ...
    void setUp() throws NoSuchFieldException {
        ...
        when(context.get(eq(ComponentRef.of(providerType)))).thenReturn(Optional.of(dependencyProvider));
    }
    ...
    public class ConstructorInjection {
        ...
        class Injection {
            ...
            void should_include_dependency_types_from_inject_constructor() {
                ...
                assertArrayEquals(new ComponentRef[]{ComponentRef.of(providerType)},
                        provider.getDependencies().toArray());
            }
